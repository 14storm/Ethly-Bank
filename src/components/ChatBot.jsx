...
const canned = [
  ...
  "We take security seriously. All your data is encrypted and protected.",
  "Ethly is designed to be simple and intuitive. Let us know if you have feedback!",
  "You can manage your account, cards, and payments all in one place.",];
