...
const StyledWrapper = styled.div`
  ...
  #gnd {
    ...
    rotate: 10deg;
    z-index: -1;
    filter: blur(0.5px) drop-shadow(1px 3px 5px rgba(17,17,17,0.4));
    opacity: 0.2;
